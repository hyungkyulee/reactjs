...
class Contact extends Component {
  ...
  handleSubmit = (values) => {
      ...
      this.props.postFeedback(values.firstname, values.lastname, values.phonenumber, values.email, values.agree, values.contactType, values.message)
                  ...
                  <Row className="form-group">
                      ...
                      <Col md={10}>
                          ...
                          <Errors
                              ...
                              messages={{
                                  required: 'Required',
                                  validEmail: (val) => `${val} is invalid email address`,
                              }}
                            />
                      </Col>
                  </Row>
